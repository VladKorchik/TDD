...
{
    //  по-хорошему приведённые ниже формулы неверные. У меня получается,
    ...
    //  Но раз задание творческое, то я немного упростил задачу и не стал забивать тесты огромныем количеством формул.
